      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex-gap-1 pt-2'>
            <input onChange={()=> isEdit && setProfileData(prev => ({...prev,available: !profileData.available}))} checked={profileData.available} type="checkbox" className='accent-teal-600' name="" id="" />
